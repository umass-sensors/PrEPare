...
package edu.umass.cs.mobile.metawear;
...
public class DeviceSetupActivity extends AppCompatActivity implements ServiceConnection, DeviceSetupActivityFragment.FragmentSettings {
    public final static String EXTRA_BT_DEVICE= "edu.umass.cs.metawear.DeviceSetupActivity.EXTRA_BT_DEVICE";

    public static class ReconnectDialogFragment extends DialogFragment implements  ServiceConnection {
        private static final String KEY_BLUETOOTH_DEVICE = "edu.umass.cs.metawear.DeviceSetupActivity.ReconnectDialogFragment.KEY_BLUETOOTH_DEVICE";
