...
public class DataWriterService extends Service {
    ...
    private final BufferedWriter accelWriter = null; // FileUtil.getFileWriter(ACCEL_TAG); //TODO: FIX THESE

    /** Buffered writer used to log the gyroscope data */
    private final BufferedWriter gyroWriter = null; //FileUtil.getFileWriter(GYRO_TAG);

    /** Buffered writer used to log the reported labels */
    private final BufferedWriter labelWriter = null; // FileUtil.getFileWriter(LABEL_TAG);
