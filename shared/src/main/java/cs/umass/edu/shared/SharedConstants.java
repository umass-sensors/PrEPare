...
public class SharedConstants {
    ...
    public interface COMMANDS {
        ...
        String START_METAWEAR_SERVICE = "edu.umass.cs.shared.commands.start-metawear-service";
        String STOP_METAWEAR_SERVICE = "edu.umass.cs.shared.commands.stop-metawear-service";
    }
}
